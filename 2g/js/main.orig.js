            ...
            getApi("tickets/"+localStorage.getItem('ticketNumber')).then(
                function(returnData) {
                    ...
                    for(var c = 1; c < returnData.ticketlogs.length; c++)
                    {
                        ...
                        // comment insert
                        var insert = "<ul class='commentBlock'><li><img src='img/EyeIcon.png' class='commentImg'></li><li class='commentText'><h3>"+userName+"</h3></li><li><span>"+date+"</span></li><li class='commentText'><p>"+ $("<span />", { html: note }).text().replace(/\n/g, '<p></p>').replace("/<br>/g", "<p></p>")+"</p></li><li>"+type+"</li></ul>";
                    ...
                    var orginalMessageinsert = "<ul class='commentBlock'><li><img src='img/EyeIcon.png' class='commentImg'></li><li class='commentText'><h3>"+returnData.ticketlogs[0].user_firstname+" "+returnData.ticketlogs[0].user_lastname+"</h3></li><li><span>"+orginalMessageDate+"</span></li><li class='commentText'><p>"+$("<span />", { html: returnData.ticketlogs[0].note }).text().replace(/\n/g, '<p></p>').replace("<br>", "<p></p>")+"</p></li><li>"+returnData.ticketlogs[0].log_type+"</li></ul></div>";
                ...
                success: function(returnData) {
                    ...
                    if(returnData.recipients != null && returnData.recipients.length > 0){
                        for(var x = 0; x < returnData.recipients.length; x++)
                        {
                            ...
                            var insert = "<li><ul class='recipientDetail'><li><img src='img/EyeIcon.png'></li><li><div class='recipient'><p>"+returnData.recipients[x].email+"</p>" +
            ...
            */
            getApi('time', {"limit" : 200}).then(function(returnData) {
                    ...
                    for(var i = 0; i < returnData.length; i++)
                    {
                        ...
                        var log = "<li class=item><ul class='timelog' data-id="+id+" data-info='"+JSON.stringify(returnData[i]).replace(/'/g, "")+"'> <li><img class='timelogProfile' src='img/EyeIcon.png'></li><li><h2 class='feedName user_name'>"+nameCheck+"</h2><p class='taskDescription responseText'>"+text+"</p></li><li><img class='feedClock'src='img/clock_icon_small.png'><h3 class='feedTime'><span>"+hours+"</span></h3></li></ul></li>";
        ...
        getTimeLogs: function () {
            ...
            getApi("time?account=" + accountId).then(function(returnData) {
                    ...
                    for(var i = 0; i < returnData.length; i++)
                    {
                        ...
                        var nameCheck = returnData[i].user_name;
                        nameCheck = createElipse(nameCheck, .50, 12);
                        var log = "<li><ul class='timelog' data-info='"+JSON.stringify(returnData[i]).replace(/'/g, "")+"'> <li><img class='timelogProfile' src='img/EyeIcon.png'></li><li><h2 class='feedName'>"+nameCheck+"</h2><p class='taskDescription'>"+text+"</p></li><li><img class='feedClock'src='img/clock_icon_small.png'><h3 class='feedTime'><span>"+hours+"</span></h3></li></ul></li>";
        ...
        userData:function() {
            ...
            $.ajax({
                ...
                success: function(returnData) {
                    ...
                    $(".navProfile").attr("src","img/EyeIcon.png");
