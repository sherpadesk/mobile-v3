...
var fastClicker = {
    ...
    var NAV_MENU="<div class='activeNav'><div class='fold'><i class='fa a-angle-double-left fa-2x'></i></div><img class='navProfile' src='img/profile_3.png'><h2 class='navName'>NO USER DATA</h2><ul class='sideNavLinks'><a href='dashboard.html'><li id='itemDash'><a href='dashboard.html'><div class='iconCircle'><i class='ion-ios-speedometer ionFont'></i></div><h3>Dashboard</h3></a></li></a> <a class='user' href='ticket_list.html'><li id='itemTickets'><div class='iconCircle'><i class='ion-compose ionFont'></i></div><h3>Tickets</h3><div class='menuTicketsStat'><p class='menuTicketStatNumber'>0</p></div></li></a> <a class='time' href='timelog.html'><li id='itemTimelog' class='sdonly'><div class='iconCircle'><i class='ion-android-time ionFont'></i></div><h3>Timelogs</h3></li></a> <a href='Account_List.html'><li id='itemAccount' class='sdonly'><div class='iconCircle'><i class='ion-ios-people ionFont'></i></div><h3>Accounts</h3></li></a><a href='allInvoice_List.html'><li class='sdonly time' id='itemInvoice' ><div class='iconCircle'><i class='ion-card ionFont'></i></div><h3 id='allInvoice'>Invoices</h3></li></a><a href='Queues.html'><li id='itemQueues'><div class='iconCircle'><i class='ion-ios-list-outline ionFont'></i></div><h3>Queues</h3></li></a><li class='user' id='switchOrg'><div class='iconCircle'><i class='ion-arrow-swap ionFont'></i></div><h3>Switch Org</h3></li><li class='user' id='signOut'><div class='iconCircle'><i class='ion-log-in ionFont'></i></div><h3>Signout</h3></li><a class='fullapplink user' href='#'><li><div class='iconCircle'><i class='ion-share ionFont'></i></div><h3>Full App</h3></li></a></ul></div>";
    
    var CREATE_MENU="<div class='createActions'><ul class='createActionsList Absolute-Center'><li onclick='window.location.replace(\"add_tickets.html\");'><i class='ion-compose ionFont'></i><p>Add Ticket</p></li><li class='time' onclick='window.location.replace(\"add_time.html\");'><i class='ion-android-time ionFont'></i><p>Add Time</p></li><li class='sdonly' id='itemUnInvoice'  onclick='window.location.replace(\"unInvoice_List.html\");'><i class='ion-card ionFont'></i><p>Add Invoice</p></li><li class='expense' onclick='window.location.replace(\"addExpence.html\");'><i class='ion-cash ionCash'></i><p>Add Expense</p></li></ul></div>";
