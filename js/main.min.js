            ...
            getApi("invoices"+data).then(function(returnData) {
                ...
                if(returnData.recipients && returnData.recipients.length > 0){
                    ...
                    for(var x = 0; x < returnData.recipients.length; x++)
                    {
                        ...
                        insert += "<li class=recipientParent><ul class='recipientDetail'><li><img src='http://www.gravatar.com/avatar/" + email + "?d=mm&s=80'></li><li><div class='recipient'><p>"+createElipse(returnData.recipients[x].email, 0.9, 12)+"</p>" +
