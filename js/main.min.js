...
if (isExtension) $( window ).unload(function() { localStorage.setItem("referrer", Page); });
        ...
        showTicket:function(){
            ...
            getApi("tickets/"+localStorage.getItem('ticketNumber')).then(
                ...
                function(e) {
                    ...
                    userMessage.showMessage(false, "No ticket found. Going back to the list.");
                    setTimeout(function(){
        ...
        getApi("config").then(function (returnData) {            
            ...
            if (is_redirect)
            {
                if (isExtension){
                    ...
                    console.log(reff);
                    if (reff) window.location.replace(reff);
                }
                if (isTech)
