...
$(document).ready(function(){
    ...
    var detailedInvoice = {
        ...
        specifics:function(){
            var data = localStorage.invoiceNumber.toString();
            if (!data){
                backFunction(); 
            }
            if (data.indexOf(",") != -1)
            ...
            getApi("invoices"+data).then(function(returnData) {
                ...
                if(returnData.time_logs.length){
                    ...
                    for(var u = 0; u < returnData.time_logs.length; u++)
                    {
                       ...
                       //var logID = returnData.time_logs[u].id;
                        ...
                        var insert = "<li><input class=time type=checkbox value=>" + returnData.time_logs[u].hours + " hours by " + name + ticketNumber + " at " + date + "</li>";
                ...
                if(returnData.travel_logs.length){
                    $("#TravelLogs").show1();
